...
pTime = 0
pLength = 0
detector = htm.handDetector()  # detector object
...
volRange = volume.GetVolumeRange()  # getting the range of volume
# print(volRange)
minVol = volRange[0]
maxVol = volRange[1]
...
while True:
    ...
    sucess, img = cap.read()
    # detecting the hand and landmarks
    img = detector.findHands(img)
    # detecting the position of the list
    lmList = detector.findPosition(img, False)
    if len(lmList) != 0:
        # print(lmList[4], lmList[8])

        # detecting the length of the two fingertips
        ...
        # drawing rectangle for the detected hand.
